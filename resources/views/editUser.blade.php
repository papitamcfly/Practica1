                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('edituser', $user->id) }}">
                            ...
                            <div class="row mb-3">
                                <label for="lastname_p" class="col-md-4 col-form-label text-md-end">{{ __('Apellido Paterno') }}</label>

                                <div class="col-md-6">
                                    <input id="lastname_p" type="text" class="form-control @error('lastname_p') is-invalid @enderror" name="lastname_p" value="{{ old('lastname_p', $user->lastname_p) }}" >
                            ...
                            <div class="row mb-3">
                                <label for="lastname_m" class="col-md-4 col-form-label text-md-end">{{ __('Apellido Materno') }}</label>

                                <div class="col-md-6">
                                    <input id="lastname_m" type="text" class="form-control @error('lastname_m') is-invalid @enderror" name="lastname_m" value="{{ old('lastname_m', $user->lastname_m) }}" >
